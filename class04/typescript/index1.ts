...
function sum2(num1:number, num2:number){ // In this we are defining the function name and place to hold values which we can enter before executing function like we did in line 33
    let sum2 = num1 * num2
